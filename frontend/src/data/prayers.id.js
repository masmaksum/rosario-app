// Teks doa Rosario — Bahasa Indonesia.
// Dipakai oleh i18n.js sebagai PRAYERS_ID.

export const PRAYERS_ID = {
  "tanda-salib": {
    id: "tanda-salib",
    title: "Tanda Salib",
    leaderText: "Dalam nama Bapa, dan Putera, dan Roh Kudus.",
    responseText: "Amin.",
  ...
  "kemuliaan": {
    id: "kemuliaan",
    title: "Kemuliaan",
    leaderText: "Kemuliaan kepada Bapa, dan Putera, dan Roh Kudus.",
    responseText: "Seperti pada permulaan, sekarang, selalu, dan sepanjang segala abad. Amin.",
    text:
  ...
  "terpujilah": {
    id: "terpujilah",
    title: "Terpujilah",
    leaderText: "Terpujilah nama Yesus, Maria, dan Santo Yosef.",
    responseText: "Sekarang dan selama-lamanya. Amin.",
