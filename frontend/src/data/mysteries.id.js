// Peristiwa Rosario — Bahasa Indonesia.
// ID kanonik: joyful / sorrowful / glorious / luminous.
// recommendedDays memakai nama hari bahasa Inggris lowercase untuk konsistensi lintas bahasa.

export const MYSTERIES_ID = [
  {
    id: "joyful",
    name: "Peristiwa Gembira",
    shortName: "Gembira",
    description: "Merenungkan sukacita Inkarnasi: kabar gembira hingga Yesus ditemukan di Bait Allah.",
    color: "joyful",
    ...
    events: [
      {
        ...
        leaderText:
          "Salam, hai engkau yang dikaruniai, Tuhan menyertai engkau. Jangan takut, hai Maria, " +
          "sebab engkau beroleh kasih karunia di hadapan Allah. Sesungguhnya engkau akan mengandung " +
          "dan akan melahirkan seorang anak laki-laki dan hendaklah engkau menamai Dia Yesus.",
        responseText:
          "Bapa, jika Engkau bersabda maka semuanya terjadi. Bersabdalah ya Bapa, aku ini adalah " +
          "hamba-Mu. Terjadilah padaku menurut kehendak-Mu.",
      },
      {
        order: 2,
      ...
      },
      {
        ...
        responseText:
          "Bapa, kami bersyukur karena Engkau telah merelakan Putra-Mu menjadi manusia demi menebus " +
          "dan mengampuni dosa-dosa kami. Jadikanlah kami layak menjadi anak-anak-Mu.",
      },
      {
        order: 4,
        ...
        responseText:
          "Bapa, kami mempersembahkan segenap diri kami kepada-Mu. Terimalah kami sebagai " +
      ...
      },
      {
        ...
        leaderText:
          "“Mengapa kamu mencari Aku? Tidakkah kamu tahu, bahwa Aku harus berada di dalam rumah " +
          "Bapa-Ku?” Tetapi mereka tidak mengerti apa yang dikatakan-Nya kepada mereka.",
        responseText:
          "Bapa, Putra-Mu sepenuhnya hidup demi kemuliaan-Mu dan keselamatan kami. " +
          "Bentuklah kami menjadi serupa dengan Putra-Mu.",
      },
    ],
  },
  {
    ...
    shortName: "Sedih",
    description: "Merenungkan sengsara Tuhan: dari Taman Getsemani hingga wafat-Nya di salib.",
    color: "sorrowful",
    ...
    events: [
      {
        ...
        leaderText:
          "“Ya Bapa-Ku, jikalau Engkau berkenan, ambillah cawan ini dari hadapan-Ku, tetapi " +
          "janganlah menurut kehendak-Ku, melainkan kehendak-Mu yang terjadi.”",
        responseText:
      ...
      },
      {
        ...
        leaderText:
          ...
          "mengenakan lagi pakaian-Nya.",
        responseText:
          "Bapa, berilah kami rahmat untuk selalu mengingat sengsara-Mu, agar kami dapat berdiri " +
      ...
      },
      {
        ...
        leaderText:
          "Mereka menganyam sebuah mahkota duri dan menaruh di atas kepala-Nya. Kemudian mereka " +
          "mulai memberi hormat kepada-Nya, katanya: “Salam, hai raja orang Yahudi!”",
        responseText:
      ...
      },
      {
        ...
        leaderText:
          "Sambil memikul salib-Nya, Ia pergi keluar ke tempat yang bernama tempat tengkorak, " +
  ...
  },
  {
    ...
    shortName: "Mulia",
    description: "Merenungkan kemenangan Kristus: kebangkitan, kenaikan, hingga pemahkotaan Maria.",
    color: "glorious",
    ...
    events: [
      {
        ...
        leaderText:
          ...
          "disalibkan itu. Ia tidak di sini, sebab Ia telah bangkit, sama seperti yang telah " +
          "dikatakan-Nya.”",
        responseText:
          "Bapa, mampukanlah kami melanjutkan misi Putra-Mu yaitu memberitakan Injil kepada semua " +
      ...
      },
      {
        ...
        leaderText:
          ...
          "menutup-Nya dari pandangan mereka. “Hai orang Galilea, mengapa kamu berdiri melihat ke " +
          "langit? Yesus ini yang diangkat ke surga meninggalkan kamu, akan kembali dengan cara yang " +
          "sama seperti kamu melihat Dia naik ke surga.”",
        responseText:
      ...
      },
      {
        ...
        leaderText:
          ...
          "rumah di mana mereka duduk... Lalu mereka semua dipenuhi Roh Kudus dan mulai berbicara " +
      ...
      },
      {
        ...
        leaderText:
          "Jikalau kita percaya bahwa Yesus telah mati dan telah bangkit, maka kita percaya juga " +
          "bahwa dengan perantaraan Yesus, Allah akan mengumpulkan bersama-sama dengan Dia mereka " +
          "yang telah meninggal. Sesudah itu kita yang hidup, yang masih tinggal, akan diangkat " +
      ...
      },
      {
        ...
        responseText:
          "Bapa, satu-satunya sumber kasih sejati, kobarkanlah dalam diri kami semangat kasih-Mu " +
          "kepada Bunda Putra-Mu, sebab kami memandangnya sebagai teladan pengikut Yesus.",
      },
    ],
  },
  {
    ...
    shortName: "Terang",
    description: "Merenungkan pewartaan Yesus: dari pembaptisan hingga penetapan Ekaristi.",
    color: "luminous",
    ...
    events: [
      {
        ...
        leaderText:
          ...
          "suara dari surga yang mengatakan: “Inilah Anak-Ku yang terkasih, kepada-Nya Aku berkenan.”",
        responseText:
          "Bapa, kami pun Engkau beri misi sebagai anak-Mu dan pengikut Yesus. Buatlah kami " +
          "menerima tugas itu dengan hati terbuka dan penuh sukacita.",
      },
      {
        order: 2,
      ...
      },
      {
        ...
        leaderText:
          "“Bertobatlah, sebab Kerajaan Surga sudah dekat!” Yesus pun berkeliling di seluruh " +
          "Galilea, Ia mengajar dalam rumah-rumah ibadat dan memberitakan Injil Kerajaan Surga serta " +
          "menyembuhkan orang-orang di antara bangsa itu.",
        responseText:
          "Bapa, pertobatkanlah kami, ampunilah dosa kami. Jadikanlah kami mampu mengampuni orang " +
      ...
      },
      {
        ...
        leaderText:
          "Yesus berubah rupa di sebuah gunung yang tinggi, wajah-Nya bercahaya seperti matahari. " +
          "Allah bersabda kepada tiga Rasul Yesus, “Inilah Anak-Ku yang terkasih, kepada-Nyalah " +
          "Aku berkenan, dengarkanlah Dia.”",
        responseText:
          "Bapa, ajarilah kami mendengarkan Yesus dan sepenuhnya menerima ajaran-Nya. Izinkanlah " +
      ...
      },
      {
        ...
        leaderText:
          ...
          "syukur lalu memberikannya kepada mereka. Ia berkata: “Inilah darah-Ku yang ditumpahkan " +
          "bagi banyak orang.”",
        responseText:
          "Bapa, sucikan dan kuduskanlah kami pada saat kami menerima Tubuh dan Darah Putra-Mu yang " +
          "terkasih. Pakailah kami seturut kehendak-Mu.",
      },
    ],
  },
];
...
export function getMysteryById(id) {
  return MYSTERIES_ID.find((m) => m.id === id);
}
